...
if ($arg1 == "processing_scripts/processing_inclusive.groovy") then
    ...
    set convert_arg3 = 6 # calibration
else if ($arg1 == "processing_scripts/processing_tcs.groovy") then
    set convert_arg3 = 7 # tcs
else if ($arg1 == "processing_scripts/processing_mc_tcs.groovy") then
    set convert_arg3 = 7 # tcs
else if ($arg1 == "processing_scripts/processing_ntcs.groovy") then
...
if ($arg1 == "processing_scripts/processing_inclusive.groovy") then
    ...
    coatjava/bin/run-groovy -cp processing_classes/dist/processing_classes.jar "$arg1" "$arg2" "$3" "$4" "$5" "$6" "$7" "$8"
    # Run the convert_txt_to_root program
    set txt_file = "$4.txt"
    set root_file = "$4.root"
    ./processing_scripts/convert_txt_to_root $txt_file $root_file $convert_arg3 $is_mc
