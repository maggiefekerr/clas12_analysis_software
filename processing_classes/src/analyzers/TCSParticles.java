...
public class TCSParticles {
    ...
    protected int num_electrons, num_piplus, num_piminus, num_kplus, num_kminus, num_protons, num_particles;
    ...
    protected double prot_px, prot_py, prot_pz, prot_p, prot_e, prot_theta, prot_phi; // positron kinematics
