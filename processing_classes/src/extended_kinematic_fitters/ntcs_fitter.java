...
public class ntcs_fitter extends GenericKinematicFitter {

    protected final Double mybeam;

    public ntcs_fitter(double beam) {
        super(beam);
        mybeam = beam;
    }

    // may need to add more tests in here, see commented out in tcs_fitter
    ////////////////////////////////////////////////////////////////////////////////////////////////
    @Override
    public PhysicsEvent getPhysicsEvent(DataEvent event) {
        ...
        if (generic_tests.banks_test(event)) {
            ...
            if (rec_Bank.getInt("pid", 0) == 11) {
                ...
                // highest momentum electron listed first
