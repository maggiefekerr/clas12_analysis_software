...
// .x prac_comp_data_gepard.C("fall2018_out.root", 0.126, 1.759, -0.670, 10.604, 9, 0.89)
// How I run this
...
void prac_comp_data_gepard(TString file, Double_t xB, Double_t q2, Double_t t, Int_t numBins, Double_t E_beam=10.604, Double_t beamPol=0.89){ // lowercase q2 is just so ROOT doesn't crash out
    ...
    Int_t numBinDiv = 10;
    TH1F *hAsymKM15 = new TH1F("", "", numBins*numBinDiv, 0, 2*TMath::Pi());
    ...
    c1->Update();
    c1->SaveAs("prac_comp-data-depard_comp.png");
}